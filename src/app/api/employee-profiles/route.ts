        ...
        if (existingProfile) {
            ...
            const updateQuery = `
                UPDATE employee_profiles SET
                    ...
                    relevant_certificates = ?, agricultural_training = ?, languages_spoken = ?,
                    ...
                    employer_references = ?, technical_skills = ?, preferred_regions = ?,
            ...
            updateStmt.run(
                ...
                JSON.stringify(profileData.relevantCertificates || []),
            ...
            const insertQuery = `
                INSERT INTO employee_profiles (
                    ...
                    working_profile_description, highest_education_level, relevant_certificates,
                    ...
                    preferred_regions, work_type_desired, preferred_enterprise, expected_salary_min,
